# The name of this view in Looker is "Dm Ot Ordenamiento Territorial"
view: dm_ot_ordenamiento_territorial {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `terridata.DM_OT_ORDENAMIENTO_TERRITORIAL` ;;
